...
% \includeonly{lectures/7-combinatorics}
...
\mainmatter
\include{lectures/1-intro/00-intro}
\include{lectures/2-logic}
\include{lectures/3-collections}
\include{lectures/4-induction}
\include{lectures/5-automata}
\include{lectures/6-sums}
\include{lectures/7-combinatorics}
